...
namespace zizther\replacevariable;

use zizther\replacevariable\services\ReplaceVariableService as ReplaceVariableServiceService;
use zizther\replacevariable\twigextensions\ReplaceVariableTwigExtension;
 ...
 * @since     1.0.0
 *
 * @property  ReplaceVariableServiceService $replaceVariableService
 */
class ReplaceVariable extends Plugin
{
    // Static Properties
    // =========================================================================
    ...
    public function init()
    {
        ...
        Craft::$app->view->registerTwigExtension(new ReplaceVariableTwigExtension());
